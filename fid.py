...
def calculate_inception_stats(
    ...
    # Download from https://api.ngc.nvidia.com/v2/models/nvidia/research/stylegan3/versions/1/files/metrics/inception-2015-12-05.pkl
    detector_url = '../inception/inception-2015-12-05.pkl'
...
def calc(image_path, ref_path, num_expected, seed, batch):
    ...
    if dist.get_rank() == 0:
        ...
        with open(os.path.join(os.path.dirname(image_path), 'fid.txt'), 'w') as f:
            f.write(str(fid))
    torch.distributed.barrier()
